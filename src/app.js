    ...
    case STATES.PLAY:
      ...
      switch (gameStage) {
        ...
        case 9:
          ...
          // LEVEL 6
          case 10:
            bossy.moveX( - GAME_SPEED_RESCALED * 0.1);
            drawPipes(GAME_SPEED_RESCALED, SIZE_PIPE_HARD);
            drawBossy(GAME_SPEED_RESCALED * 0.3);
            shootMissileBossy(GAME_SPEED_RESCALED * 0.5, 1500);
            drawLazyKaze(GAME_SPEED_RESCALED);
            // if (score > SCORE.LVL5) {
...
function handleSound() {
  switch (gameState) {
    case STATES.MENU:
      stopSound(soundList[SOUND_LIST.SONG] , 0.5);
      playSound(soundList[SOUND_LIST.MENU] , 0.5); 
      break;


    case STATES.PLAY:
      stopSound(soundList[SOUND_LIST.MENU] , 0.5);
    ...
    case STATES.GAME_OVER:
      stopSound(soundList[SOUND_LIST.SONG], 0.7);
      break;
